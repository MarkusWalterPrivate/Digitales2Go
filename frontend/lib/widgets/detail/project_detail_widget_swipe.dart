...
/// ProjectDetailView
class ProjectDetailViewSwipe extends StatefulWidget {
  ProjectDetailViewSwipe(
      {Key? key,
      this.projectDetail,
  ...
  @override
  State<ProjectDetailViewSwipe> createState() => _ProjectDetailViewSwipeState();
}

class _ProjectDetailViewSwipeState extends State<ProjectDetailViewSwipe>
