...
enum SlideRegion { inNopeRegion, inLikeRegion, inSuperLikeRegion, inSkipRegion }
...
class _DraggableCardState extends State<DraggableCard>
  ...
  void _onPanUpdate(DragUpdateDetails details) {
    ...
    setState(() {
      ...
      //For if both, top and bottom swipe should be possible
      /* else if (isInTopRegion || isInBottomRegion) {
        print("top or bottom region");
        slideRegion = isInTopRegion
            ? SlideRegion.inSuperLikeRegion
            : SlideRegion.inSkipRegion;
      } */
      else {
        slideRegion = null;
      }
    ...
    setState(() {
      if (isInLeftRegion || isInRightRegion) {
        ...
        if (widget.upSwipeAllowed) {
          ...
          slideOutAnimation.forward(from: 0.0);
          if (isInBottomRegion) slideOutDirection = SlideDirection.down;
        } else {
